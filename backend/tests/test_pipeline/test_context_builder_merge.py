...
class TestMergeConsecutive:
    ...
    def test_merge_consecutive_option_exists(self):
        ...
        docs = [
            Document(id="1", text="First part", score=0.9, metadata={"source": "file1.py", "start": 0, "end": 10}),
            Document(id="2", text="Second part", score=0.8, metadata={"source": "file1.py", "start": 10, "end": 20}),
            Document(id="3", text="Different file", score=0.7, metadata={"source": "file2.py", "start": 0, "end": 10}),
        ]
    ...
    def test_merge_consecutive_same_source(self):
        ...
        docs = [
            Document(id="1", text="Line 1: function foo() {", score=0.9, metadata={"source": "file1.py", "start": 0, "end": 20}),
            Document(id="2", text="Line 2:   return 42;", score=0.9, metadata={"source": "file1.py", "start": 20, "end": 40}),
            Document(id="3", text="Line 3: }", score=0.9, metadata={"source": "file1.py", "start": 40, "end": 45}),
        ]
    ...
    def test_merge_consecutive_preserves_metadata(self):
        ...
        docs = [
            Document(id="1", text="Part 1", score=0.9, metadata={"source": "test.py", "lines": "1-10"}),
            Document(id="2", text="Part 2", score=0.9, metadata={"source": "test.py", "lines": "11-20"}),
        ]
    ...
    def test_merge_consecutive_with_deduplication(self):
        ...
        docs = [
            ...
            Document(id="1", text="Content A duplicate", score=0.8, metadata={"source": "test.py"}),  # Duplicate of id=1
        ]
        
        result = builder.build(docs, limit=3, options={"remove_duplicates": True, "merge_consecutive": True})
