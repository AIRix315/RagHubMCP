...
class BaseRerankProvider(BaseProvider):
    ...
    async def arerank(self, query: str, documents: list[str], top_k: int = 5) -> list[RerankResult]:
    ...
    def rerank_with_metadata(
        self, query: str, documents: list[dict[str, Any]], text_key: str = "text", top_k: int = 5
    ) -> list[dict[str, Any]]:
