...
class NetworkXStore(GraphStore):
    ...
    def find_all_paths(
        self, source_id: str, target_id: str, cutoff: int | None = None
    ) -> list[list[GraphNode]]:
        ...
        try:
            ...
            return [[self._nodes[nid] for nid in path if nid in self._nodes] for path in paths]
        except nx.NetworkXNoPath:
            return []
    ...
    def get_statistics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "strongly_connected_components": nx.number_strongly_connected_components(self._graph)
            if self._graph.number_of_nodes() > 0
            else 0,
        }
