...
class Container:
    ...
    def registerSingleton(self, name: str, factory: Callable[[], T]) -> None:
    ...
    def registerTransient(self, name: str, factory: Callable[[], T]) -> None:
...
def injectable(name: str | None = None, singleton: bool = True):
    ...
    def decorator(cls: type[T]) -> type[T]:
        ...
        if singleton:
            container.registerSingleton(name or cls.__name__, lambda: cls())
        else:
            container.registerTransient(name or cls.__name__, lambda: cls())
        return cls
    return decorator
