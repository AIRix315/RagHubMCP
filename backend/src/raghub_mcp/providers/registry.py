...
from raghub_mcp.common.registry import Registry

from .base import BaseProvider, ProviderCategory, UnsupportedProviderError
...
class ProviderRegistry(Registry[BaseProvider, ProviderCategory]):
    ...
    def register(self, category: ProviderCategory, name: str) -> Callable[[type], type]:
