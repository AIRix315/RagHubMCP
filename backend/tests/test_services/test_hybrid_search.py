...
class TestReciprocalRankFusion:
    ...
    def test_rrf_weights(self):
        ...
        fused_alpha = reciprocal_rank_fusion(vector_results, bm25_results, k=60, alpha=0.9, beta=0.1)
...
class TestHybridSearchService:
    ...
    def test_search_returns_results(
        self, mock_chroma_service, mock_bm25_service
    ):
    ...
    def test_search_with_where_filter(
        ...
        """TC-HYB-4.5: Search with where filter."""
        reset_hybrid_search_service()
        ...
        # Verify where filter was passed to ChromaDB query
    ...
    def test_search_empty_results(self, mock_chroma_service, mock_bm25_service):
        ...
        # Empty results from both services
