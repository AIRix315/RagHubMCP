...
class TestPathTraversalSecurity:
    ...
    def test_path_traversal_with_parent_directory(self) -> None:
        ...
        for path in malicious_paths:
            ...
            assert "not allowed" in result_lower or "invalid" in result_lower or "forbidden" in result_lower or "not in allowed" in result_lower
...
class TestPathSecurityIntegration:
    ...
    def test_index_endpoint_rejects_path_traversal(
        ...
        from src.utils.config import IndexerConfig, AppConfig
